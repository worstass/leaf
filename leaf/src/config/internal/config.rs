...
#[derive(PartialEq,Clone,Default,Debug)]
// @@protoc_insertion_point(message:PacketInboundSettings)
pub struct PacketInboundSettings {
    // message fields
    // @@protoc_insertion_point(field:PacketInboundSettings.sink)
    pub sink: ::protobuf::EnumOrUnknown<packet_inbound_settings::Sink>,
    // @@protoc_insertion_point(field:PacketInboundSettings.fd)
    pub fd: i32,
    // @@protoc_insertion_point(field:PacketInboundSettings.port)
    pub port: u32,
    // @@protoc_insertion_point(field:PacketInboundSettings.pipe)
    pub pipe: ::std::string::String,
    // @@protoc_insertion_point(field:PacketInboundSettings.pi)
    pub pi: bool,
    // @@protoc_insertion_point(field:PacketInboundSettings.mtu)
    pub mtu: i32,
    // @@protoc_insertion_point(field:PacketInboundSettings.fake_dns_exclude)
    pub fake_dns_exclude: ::std::vec::Vec<::std::string::String>,
    // @@protoc_insertion_point(field:PacketInboundSettings.fake_dns_include)
    pub fake_dns_include: ::std::vec::Vec<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:PacketInboundSettings.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a PacketInboundSettings {
    fn default() -> &'a PacketInboundSettings {
        <PacketInboundSettings as ::protobuf::Message>::default_instance()
    }
}

impl PacketInboundSettings {
    pub fn new() -> PacketInboundSettings {
        ::std::default::Default::default()
    }
}

impl ::protobuf::Message for PacketInboundSettings {
    const NAME: &'static str = "PacketInboundSettings";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.sink = is.read_enum_or_unknown()?;
                },
                16 => {
                    self.fd = is.read_int32()?;
                },
                ...
                34 => {
                    self.pipe = is.read_string()?;
                },
                40 => {
                    self.pi = is.read_bool()?;
                },
                48 => {
                    self.mtu = is.read_int32()?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.sink != ::protobuf::EnumOrUnknown::new(packet_inbound_settings::Sink::FD) {
            my_size += ::protobuf::rt::int32_size(1, self.sink.value());
        }
        if self.fd != 0 {
            my_size += ::protobuf::rt::int32_size(2, self.fd);
        }
        if self.port != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.sink != ::protobuf::EnumOrUnknown::new(packet_inbound_settings::Sink::FD) {
            os.write_enum(1, ::protobuf::EnumOrUnknown::value(&self.sink))?;
        }
        if self.fd != 0 {
    ...
    fn new() -> PacketInboundSettings {
        PacketInboundSettings::new()
    }

    fn clear(&mut self) {
        self.sink = ::protobuf::EnumOrUnknown::new(packet_inbound_settings::Sink::FD);
        self.fd = 0;
        self.port = 0;
        self.pipe.clear();
        self.pi = false;
    ...
    fn default_instance() -> &'static PacketInboundSettings {
        static instance: PacketInboundSettings = PacketInboundSettings {
            sink: ::protobuf::EnumOrUnknown::from_i32(0),
            fd: 0,
            port: 0,
            pipe: ::std::string::String::new(),
            pi: false,
            mtu: 0,
            fake_dns_exclude: ::std::vec::Vec::new(),
            fake_dns_include: ::std::vec::Vec::new(),
...
/// Nested message and enums of message `PacketInboundSettings`
pub mod packet_inbound_settings {
    #[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
    // @@protoc_insertion_point(enum:PacketInboundSettings.Sink)
    pub enum Sink {
        // @@protoc_insertion_point(enum_value:PacketInboundSettings.Sink.FD)
        FD = 0,
        // @@protoc_insertion_point(enum_value:PacketInboundSettings.Sink.TCP)
        TCP = 1,
        // @@protoc_insertion_point(enum_value:PacketInboundSettings.Sink.UDP)
        UDP = 2,
        // @@protoc_insertion_point(enum_value:PacketInboundSettings.Sink.PIPE)
        PIPE = 3,
    }

    impl ::protobuf::Enum for Sink {
        ...
        fn from_i32(value: i32) -> ::std::option::Option<Sink> {
            match value {
                0 => ::std::option::Option::Some(Sink::FD),
                1 => ::std::option::Option::Some(Sink::TCP),
                2 => ::std::option::Option::Some(Sink::UDP),
                3 => ::std::option::Option::Some(Sink::PIPE),
                _ => ::std::option::Option::None
            }
        }

        const VALUES: &'static [Sink] = &[
            Sink::FD,
            Sink::TCP,
            Sink::UDP,
            Sink::PIPE,
    ...
    impl ::std::default::Default for Sink {
        fn default() -> Self {
            Sink::FD
        }
    }
